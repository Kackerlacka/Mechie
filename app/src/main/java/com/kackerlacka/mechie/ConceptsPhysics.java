...
public class ConceptsPhysics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.concepts_physics);
        ...
        mAdapter = new ArrayAdapter<>(ConceptsPhysics.this,
                android.R.layout.simple_list_item_1,
                getResources().getStringArray(R.array.concepts_physics));
        mListView.setAdapter(mAdapter);

        mListView.setOnItemClickListener((AdapterView<?> adapterView, View view, int i, long l) -> {
            switch(i) {
                case 0:
                    Intent intent = new Intent(ConceptsPhysics.this, MechanicsCastiglianosTheorem.class);
